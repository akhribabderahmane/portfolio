...
const EducationItem = ({ educationItem }) => {
  return (
    <div className=" flex flex-row gap-4 items-center border-2 border-neutral-300 dark:border-neutral-500 p-6 rounded-xl ">
      <div>
        <img
          className=" w-24"
      ...
      <div className=" space-y-2">
        <h3 className=" text-xl font-medium">{educationItem.name}</h3>
        <p className=" text-lg text-neutral-500 relative flex sm:block  flex-col gap-1">
          {" "}
        ...
        <div className=" text-base text-neutral-500 relative">
