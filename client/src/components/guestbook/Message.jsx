...
const Message = ({ msg }) => {
  ...
  return (
    <div className=" flex flex-row gap-4 font-onest">
      <img
        src={msg.photoURL}
        alt={`${msg.author}'s avatar`}
        className=" w-10 h-10 sm:w-14 sm:h-14  rounded-full mt-2"
      />
      <div className=" space-y-1">
        ...
        <p className=" rounded-xl rounded-tl-none bg-neutral-200 dark:bg-neutral-800 text-lg sm:text-xl px-2 sm:px-4 py-1 sm:py-2 w-fit">
          {msg.text}
        </p>
      </div>
    </div>
